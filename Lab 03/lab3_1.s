...
mypow:
	mov     r2,r0
loop:                  
	cmp		r1,#1      // cheack its last loop
	moveq	pc,lr      // if its last loop return r0
	mulne	r0,r2      // find the factorial 
	subne	r1,r1,#1   // reduce the value n
	bne		loop       // not last one loop again
